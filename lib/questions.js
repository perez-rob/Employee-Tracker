      ...
      .prompt([
        {
          ...
          choices: [ new inquirer.Separator(' '), new inquirer.Separator(chalk`{white.bold Employees}`), new inquirer.Separator(), chalk`{cyan.bold view ALL}`, chalk`{cyan.bold view by DEPARTMENT}`, chalk`{cyan.bold view by MANAGER}`, chalk`{cyan.bold view by ROLE}`, chalk `{green.bold NEW employee}`, chalk `{magenta.bold update ROLE}`, chalk `{magenta.bold update MANAGER}`, chalk `{red.bold DELETE employee}`, new inquirer.Separator(" "), new inquirer.Separator(`Roles`), new inquirer.Separator(), chalk `{cyan.bold View All Roles}`, chalk `{cyan.bold View Roles by Department}`, chalk `{green.bold Add Role}`, chalk `{red.bold Remove Role}`, new inquirer.Separator(" "), new inquirer.Separator(`Departments`), new inquirer.Separator(), chalk `{cyan.bold View All Departments}`, chalk `{cyan.bold View Department Personnel Expenses}`, chalk `{green.bold Add Department}`, chalk `{red.bold Remove Department}`, new inquirer.Separator(' '), new inquirer.Separator(), chalk `{red.bold      QUIT}`, new inquirer.Separator()]
        }
      ])
      .then((answers) => {
        switch(answers.nav){
